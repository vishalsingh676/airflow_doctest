...
dag = DAG(
    "dag-73-pod", #same name as application. and there should be no underscore in application name
...
submit_spark_job = SparkKubernetesOperator(
    task_id="submit-dag-73-pod", #NOT but in blog
    executor_config={
        "env": {
            "KUBERNETES_OPERATOR_LOG_LEVEL": "DEBUG",
        },
    },
    name="dag-73-pod-spark-job", #ok
